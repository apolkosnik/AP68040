...
for t in t_integer t_exceptions t_mmu t_moves_fc t_bitfield_mmu t_cache t_fpu bench_loop; do
...
for t in integer exceptions mmu moves_fc bitfield_mmu cache fpu; do
